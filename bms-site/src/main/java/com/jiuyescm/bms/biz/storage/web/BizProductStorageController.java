...
public class BizProductStorageController extends BaseController{
	...
	private static final Logger logger = Logger.getLogger(BizProductStorageController.class.getName());
	...
	public void query(Page<BizProductStorageEntity> page, Map<String, Object> param) {
		...
		PageInfo<BizProductStorageEntity> pageInfo = bizProductStorageService.query(param, page.getPageNo(), page.getPageSize());
		if (pageInfo != null) {
	...
	@DataProvider
	public void queryMaterial(Page<BizProductStorageEntity> page, Map<String, Object> param) {
		PageInfo<BizProductStorageEntity> pageInfo = bizProductStorageService.query(param, page.getPageNo(), page.getPageSize());
		if (pageInfo != null) {
			page.setEntities(pageInfo.getList());
			page.setEntityCount((int) pageInfo.getTotal());
	...
	public String asynExport(Map<String, Object> param) {
        ...
        try {
        	...
        	String filepath=path+ FileConstant.SEPARATOR + 
        			FileTaskTypeEnum.BIZ_PRODUCT.getCode() + customerId + FileConstant.SUFFIX_XLSX;
        	...
        	entity.setTaskName(FileTaskTypeEnum.BIZ_PRODUCT.getDesc() + customerId);
		...
		return FileTaskTypeEnum.BIZ_PRODUCT.getDesc() + customerId + MessageConstant.EXPORT_TASK_BIZ_MSG;
	}
	...
	private void export(Map<String, Object> param,String taskId,String filePath)throws Exception{
    	...
    	logger.info("====应收商品库存导出：写入Excel end.==总耗时：" + (System.currentTimeMillis() - beginTime));
	}
	 ...
	 * @throws Exception
	 */
	private void handProductStorage(POISXSSUtil poiUtil, SXSSFWorkbook workbook, 
		...
		boolean doLoop = true;
		while (doLoop) {			
			PageInfo<BizProductStorageEntity> pageInfo = 
					bizProductStorageService.query(myparam, pageNo, FileConstant.EXPORTPAGESIZE);
			...
			poiUtil.exportExcel2FilePath(poiUtil, workbook, FileTaskTypeEnum.BIZ_PRODUCT.getDesc(), 
	...
	private List<Map<String, Object>> getBizHeadItem(List<BizProductStorageEntity> list){
		 List<Map<String, Object>> dataList = new ArrayList<Map<String,Object>>();
	        ...
	        for (BizProductStorageEntity entity : list) {
	        	...
	        	dataItem.put("temperature", temperatureMap.get(entity.getTemperature()));
