 ...
 * @author yangss
 */
@Controller("bizInStockController")
public class BizInStockController extends BaseController{
	
	private static final Logger logger = Logger.getLogger(BizInStockController.class.getName());
