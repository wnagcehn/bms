...
public class OutstockRecordRepositoryImpl extends MyBatisDao<BmsOutstockRecordEntity> implements IOutstockRecordRepository{
	...
	public int insert(BmsOutstockRecordEntity entity) {
		...
		return this.insert("com.jiuyescm.bms.BmsOutstockRecordMapper.save", entity);
	}

	@Override
	public int insertList(List<BmsOutstockRecordEntity> list) {
		// TODO Auto-generated method stub
		return this.insertBatch("com.jiuyescm.bms.BmsOutstockRecordMapper.save", list);
	}
	...
	public PageInfo<BmsOutstockRecordEntity> query(
		...
		// TODO Auto-generated method stub
		 List<BmsOutstockRecordEntity> list = selectList("com.jiuyescm.bms.BmsOutstockRecordMapper.query", condition, new RowBounds(
	                pageNo, pageSize));
