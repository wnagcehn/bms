...
public class ReceiveRuleRepositoryImp extends MyBatisDao implements IReceiveRuleRepository{
	...
	public List<BillRuleReceiveEntity> queryAll(Map<String, Object> parameter) {
		List<BillRuleReceiveEntity> list=selectList("com.jiuyescm.bms.rule.receiveRule.mapper.ReceiveRuleMapper.queryAllRule", parameter);
		return list;
	}
	...
	public BillRuleReceiveEntity queryRule(Map<String, Object> parameter) {
		// TODO Auto-generated method stub
		return (BillRuleReceiveEntity) super.selectOne("com.jiuyescm.bms.rule.receiveRule.mapper.ReceiveRuleMapper.queryRule", parameter);
	}
}