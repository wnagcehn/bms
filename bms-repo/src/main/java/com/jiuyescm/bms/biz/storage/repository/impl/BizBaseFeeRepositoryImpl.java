...
public class BizBaseFeeRepositoryImpl extends MyBatisDao<BizBaseFeeEntity> implements IBizBaseFeeRepository {
	...
	@Override
	public int saveList(List<BizBaseFeeEntity> addList) {
		return   insertBatch("com.jiuyescm.bms.biz.storage.BizBaseFeeEntityMapper.save",addList);
	}

	@Override
	public int updateList(List<BizBaseFeeEntity> updateList) {
		return updateBatch("com.jiuyescm.bms.biz.storage.BizBaseFeeEntityMapper.update",updateList);
	}

	@Override
	public BizBaseFeeEntity selectOne(Map<String, Object> param) {
		return (BizBaseFeeEntity)selectOne("com.jiuyescm.bms.biz.storage.BizBaseFeeEntityMapper.selectOne",param);
	}

	@Override
	public List<BizBaseFeeEntity> queryList(Map<String, Object> condition) {
		return selectList("com.jiuyescm.bms.biz.storage.BizBaseFeeEntityMapper.queryRecount",condition);
	}
