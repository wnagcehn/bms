...
public interface IPriceOutDispatchOtherDao {
	 ...
	 * @return
	 */
	public int createPriceDistribution(PriceOutDispatchOtherDetailEntity aCondition);

	/**
	 * 修改新的配送报价模板
	 * @param aCondition
	 */
	public int updatePriceDistribution(PriceOutDispatchOtherDetailEntity aCondition);
