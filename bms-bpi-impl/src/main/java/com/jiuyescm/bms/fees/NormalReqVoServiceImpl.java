...
@Service("normalReqVoService")
public class NormalReqVoServiceImpl<T> implements INormalReqVoService<T> {
	
	@Resource private IPriceGeneralQuotationRepository priceGeneralQuotationService;
	@Resource private IPriceStepQuotationRepository repository;
	@Resource private IReceiveRuleRepository receiveRuleService;
