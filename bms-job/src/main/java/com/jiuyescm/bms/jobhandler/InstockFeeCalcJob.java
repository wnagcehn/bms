...
@JobHander(value="instockFeeCalcJob")
@Service
public class InstockFeeCalcJob extends CommonCalcJob<BizInStockMasterEntity,FeesReceiveStorageEntity>{
	...
	public ReturnT<String> execute(String... params) throws Exception {
		XxlJobLogger.log("instockFeeCalcJob start.");
	...
	protected void saveBatchData(List<BizInStockMasterEntity> billList,
		...
		bizInstockMasterService.updateInstockBatch(billList);
