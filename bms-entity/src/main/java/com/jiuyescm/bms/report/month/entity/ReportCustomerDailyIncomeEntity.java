 ...
 * 
 */
public class ReportCustomerDailyIncomeEntity implements IEntity {

    
	/**
	 * 
	 */
	private static final long serialVersionUID = -7273925120836364249L;
	// id
	private int id;
	// 商家ID
	...
	public ReportCustomerDailyIncomeEntity() {
