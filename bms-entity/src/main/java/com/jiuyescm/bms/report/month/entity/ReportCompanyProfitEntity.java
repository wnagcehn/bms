 ...
 * 
 */
public class ReportCompanyProfitEntity implements IEntity {
    
	/**
	 * 
	 */
	private static final long serialVersionUID = -1044792653346714674L;
	// FeesType
	...
	public ReportCompanyProfitEntity() {
