 ...
 * 
 */
public class BmsQuoteDispatchDetailVo implements IEntity {

	private static final long serialVersionUID = 4599111493913860962L;
	...
	//报价list
	private List<BmsQuoteDispatchDetailVo> list;

	public BmsQuoteDispatchDetailVo() {
	...
	public List<BmsQuoteDispatchDetailVo> getList() {
		return list;
	}
